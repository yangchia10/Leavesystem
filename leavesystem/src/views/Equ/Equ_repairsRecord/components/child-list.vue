...
<template>
  <div class="app-container">
    ...
    <div class="filter-container-1">
      ...
      <el-button v-permission="{ name:'Equ.Permission.Money'}" class="filter-item" icon="el-icon-plus" type="success" :disabled="!mainData" @click="openAdd()">
        新增
      </el-button>

      <el-button
        v-permission="{ name:'Equ.Permission.Money'}"
        class="filter-item"
        type="primary"
        icon="el-icon-edit"
        :disabled="singleFlag"
      ...
      <el-button v-permission="{ name:'Equ.Permission.Money'}" class="filter-item" type="danger" icon="el-icon-delete" :disabled="multipleFlag" @click="handleDelete">
        刪除
      </el-button>

    </div>
    <el-table
      v-if="checkPermission(['Equ.Permission.Money'])"
      ref="multipleTable"
    ...
    >
      ...
      <el-table-column width="160px" align="center" prop="ItemCode" label="使用材料/工資" /> <!-- :label="$t('Common.select')" -->
