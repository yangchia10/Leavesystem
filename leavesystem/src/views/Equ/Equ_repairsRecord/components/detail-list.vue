...
<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column width="160px" align="center" prop="ItmsGrpCod" label="大類" /> <!-- :label="$t('Common.select')" -->
      ...
      <el-table-column v-if="checkPermission(['Equ.Permission.Money'])" width="160px" align="center" prop="Cause2" label="總部提報維修原因" />
      <el-table-column v-if="checkPermission(['Equ.Permission.Money'])" width="160px" align="center" prop="Deal" label="外部修繕/內部維修" />
      <el-table-column v-if="checkPermission(['Equ.Permission.Money'])" width="160px" align="center" prop="Final" label="最終處理結果" />
      <el-table-column v-if="checkPermission(['Equ.Permission.Money'])" width="160px" align="center" prop="Remark" label="維修內容描述" />
      <el-table-column width="160px" align="center" prop="HeadStatus" label="總公司驗收" />
      <el-table-column width="160px" align="center" prop="StoreStatus" label="門市驗收" />
